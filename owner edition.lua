...
local Window = Library.CreateLib("Timepiece Hub V.3 (OWNER EDITION)", "Sentinel")
...
OtherSection:NewButton("Arsenal Hub", "for arsenal only.", function()
    loadstring(game:HttpGetAsync("https://pastebin.com/raw/6XFzeh8u"))()  
end)
